...
@Component({
  selector: 'app-productiondashboardsummary',
  templateUrl: './productiondashboardsummary.component.html',
  styleUrls: ['./productiondashboardsummary.component.css']
})
export class ProductiondashboardsummaryComponent implements OnInit {
  ProductionDashboardSummaryform:FormGroup;
