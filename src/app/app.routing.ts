...
const appRoutes: Routes = [
    ...
    children: [
        ...
        { path: 'newproducttype', component: NewProductTypeComponent, canActivate: [AuthGuard] },
        { path: 'grower', component: GrowerComponent, canActivate: [AuthGuard, RoleGuard]},
        { path: 'city', component: CityComponent, canActivate: [AuthGuard]},
        { path: 'tpprocessor', component: TpProcessorComponent, canActivate: [AuthGuard]},
        { path: 'retailer', component: RetailerComponent, canActivate: [AuthGuard]},
        { path: 'client', component: AddNewClientComponent, canActivate: [AuthGuard]},
        { path: 'addemployee', component: AddNewEmployeeComponent, canActivate: [AuthGuard] },
        { path: 'strainmaster', component: StrainMasterComponent, canActivate: [AuthGuard] },
        { path: 'straintypemaster', component: StraintypeMasterComponent, canActivate: [AuthGuard] },
        { path: 'addnewbrand', component: AddNewBrandFormComponent, canActivate: [AuthGuard] },
        { path: 'addnewpackagetype', component: NewPackageTypeFormComponent, canActivate: [AuthGuard] },
        { path: 'addnewsubbrand', component: AddNewSubBrandFormComponent, canActivate: [AuthGuard] },
        { path: 'addnewsgenetics', component: GeneticsMasterComponent, canActivate: [AuthGuard] },
        { path: 'addtpppackagetype', component: TppPackageTypeMappingMasterComponent, canActivate: [AuthGuard] },
        ...
        { path: 'tasksetting', component: TaskSettingComponent, canActivate: [AuthGuard]},
